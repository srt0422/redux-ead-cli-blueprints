...
function getFunctionsPath(options) {
  ...
  const functionsPathSegment = options.settings.getSetting("cmdsPath") || defaultCmdsPath;
...
module.exports = {
  ...
  fileMapTokens() {
    return {
      ...
      __cmds__: options => options.settings.getSetting('cmdsPath') || defaultCmdsPath
    };
  },
